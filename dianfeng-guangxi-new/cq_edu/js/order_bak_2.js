...
var orderFlow={
	req : null //ajax 请求对象
	,orderTipsDiv2 : '<div style="position: absolute; top: 0px; left: 0px; width: 1280px; height: 720px;"> <div style="position:absolute; top:0px; left:0px; width:1280px; height:720px; background:#000000; opacity:0.4;"></div> <div style="position:absolute; top:0px; left:0px; width:1280px; height:720px; background:url('+orderFlowImgBasePath+'/images/order_bg.png);"></div> <div style="position:absolute; top:0px; left:0px; width:1280px; height:720px;"> <div id="orderTipsDiv_btn" style="position:absolute; top:450px; left:410px; width:420px; height:183px; background:url('+orderFlowImgBasePath+'/images/order_btn0.png);"> </div>'
	,orderTipsDiv2Contral : {
		focusPos : 0 //0 or 1 :初始按钮位置,0确定，1取消
				...
				orderFlow.optParentLocker(function(data){							   
					...
					/*if(data.code==0){
						...
						if(data.result.code == 200){	
							...
							//去二次确认页面
							//orderFlow.showStep('orderSecondSureDiv');
	...
	,setSuccessTipsDivBt1 : function(s,fn){//s:按钮文字，fn:按钮回调函数
		if(!!s) document.getElementById('successTipsDivBt1').innerText=s;
	...
	,show : function(){
		...
		this.successTipsDivCallBack=function(){
			var url = hostUrl+"/HiFi_cq/topic/aoyun/index.html";
			location.href = url;
		};
	}
	,hide : function(){
