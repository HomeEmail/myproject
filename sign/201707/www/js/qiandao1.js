...
tapOn($('#previewImgBt'),function(e){
	...
	var height=tplBoxSelect.height+60;//60是放文字位置
	//画布宽高
  ...
  //   });
	...
	addText(ctx,$liuyanName.val(),220,tplBoxSelect['box1'].h+(-3));
	addText(ctx,$('#liuyanDepartment').val(),220,tplBoxSelect['box1'].h+25);
	addText(ctx,$('#liuyanMail').val(),220,tplBoxSelect['box1'].h+55);
