...
tapOn($('#generateBt'),function(e){
	...
	//画布宽高
    crop_canvas.width = step1ImgObj.naturalW;
    crop_canvas.height = step1ImgObj.naturalH+100;
    ...
    //画图
    ctx.drawImage(document.getElementById('imgSelectSrc'), 0, 0, step1ImgObj.naturalW, step1ImgObj.naturalH);

    //添加文字
    addText(ctx,username,step1ImgObj.naturalW/2,step1ImgObj.naturalH+40);
    addText(ctx,bumen,step1ImgObj.naturalW/2,step1ImgObj.naturalH+80);
