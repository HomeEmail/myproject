...
tapOn($('#previewOKBt'),function(e){
    ...
    /*$.ajax({
	  ...
	  data: { hand: data,bumen:bumen,liuyan:liuyan,username:username },//上传时携带部门姓名留言信息
...
tapOn($('#generateBt'),function(e){
    ...
    crop_canvas.height = step1ImgObj.generateH+0;//多余空间放文字
    ...
    //ctx.fillRect(0,step1ImgObj.generateH-90,crop_canvas.width,90);
    //添加文字
    //addText(ctx,username,step1ImgObj.generateW-20,step1ImgObj.generateH-55);
    //addText(ctx,bumen,step1ImgObj.generateW-20,step1ImgObj.generateH-15);
